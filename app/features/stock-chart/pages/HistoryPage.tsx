...
// 走势页的路径。首页卡片要用它构造导航，同时也是把本模块拉进首页 chunk 的真实引用：
// 本文件顶层全是定义、没有副作用，光靠「import 但不用」会被打包器当作无用导入移除，
// 依赖链一断，走势页代码又退回懒加载 chunk、点击就又要等下载解析。
export const historyPath = (id: number | string) => `/holdings/${id}/history`
